...
All algorithms plateau at R² ≈ 0.18 for Kharif crops. This is not a model limitation but a **data limitation**—June satellite data lacks information about monsoon rainfall (July-August), which determines final outcomes.
